        ...
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <div class="card-body">
              ...
              ?>
              <form id="EditInspirations" method="post" action="" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control editor" name="enthusiast_services" id="enthusiast_services">{{ $hotels->enthusiast_services }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-check form-check-inline">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" value="{{ $sData->id }}" {{ $checked }}> {{ $sData->species_name }} <span class="form-check-sign"><span class="check"></span></span>
                        </label>
                      </div>
                      @endforeach
                      </div>
