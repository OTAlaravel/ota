                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-primary">
                                 ...
                                 <a href="{{ route('admin.inspirations.edit', ['lang' => $inspiration->locale, 'id' => $inspiration->id]) }}" style="color:#4caf50" title="Published">
                                     <i  class="fa fa-toggle-on" aria-hidden="true"></i>
                                 </a>
                                 @else
                                 <a href="{{ route('admin.inspirations.edit', ['lang' => $inspiration->locale, 'id' => $inspiration->id]) }}" style="color:red" title="Draft">
