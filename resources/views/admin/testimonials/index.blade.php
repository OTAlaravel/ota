                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-primary">
                                 ...
                                 <a href="{{ route('admin.states.edit', ['lang' => $testimonial->locale, 'id' => $testimonial->id]) }}" style="color:#4caf50" title="Published">
                                     <i  class="fa fa-toggle-on" aria-hidden="true"></i>
                                 </a>
                                 @else
                                 <a href="{{ route('admin.states.edit', ['lang' => $testimonial->locale, 'id' => $testimonial->id]) }}" style="color:red" title="Draft">
