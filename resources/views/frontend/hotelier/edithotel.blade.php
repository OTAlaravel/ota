...
<section class="profile dashboard hometop_gap">
 ...
 <div class="dashboard_content">
  ...
  <div class="row">
    <div class="col-sm-12">
      <button type="button" class="btn btn-primary btn-lg" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Updating now ">Update</button>
    </div>
  </div>
</form>
...
<script type="text/javascript">
 $('form#editHotel .btn').on('click', function() {
  var $this = $(this);
  $this.button('loading');
  $( "#editHotel" ).submit();
  setTimeout(function() {
